            ...
            <div className="collapse-content">
              <div className="mb-2 p-4">
                <div className="flex justify-between ">
                  ...
                  <span className="flex justify-center pb-3 text-black bold">
                    Julio 2024
                  </span>
                ...
                <div className="space-y-2 mt-4">
                  ...
                  <div className="flex justify-center space-x-10 ">
                    <button className="flex row-auto items-center border-2 border-blue-500 border-b-purple-500 border-r-purple-500 border-t-blue-500 rounded-xl text-blue">
                      <CalendarIcon className="w-6 h-6 text-white-500" />
                      Agenda
                    </button>
                    ...
                    <button className=" flex items-center row bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg p-1.5  text-white">
                      <CalendarIcon className="w-6 h-6 text-white-500" /> Turno
                    </button>
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex justify-between items-center p-2 bg-white rounded-lg shadow">
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M18 8a6 6 0 11-12 0 6 6 0 0112 0zm-8 3a7 7 0 01-7-7h1a6 6 0 0011.9 2A3.1 3.1 0 0012 11z"
                          clipRule="evenodd"
                        />
                      </svg>
