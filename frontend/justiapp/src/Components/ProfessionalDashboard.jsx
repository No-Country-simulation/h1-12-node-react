...
import ProfesionalCards from "./ProfesionalCards";
    ...
    <div className="w-11/12  min-h-screen  sm:h-full flex gap-8 justify-center items-center bg-white rounded-none max-sm:rounded-xl shadow-lg">
      <div className="flex w-1/2 gap-6  flex-col">
        ...
        <div className="flex w-full gap-8 justify-center ">
          <Link
            to="/dashboard/professional/pacientes"
            className="btn w-1/3 px-4 py-3.5 bg-gradient-to-r from-[#004e79] via-[#002279] to-[#a9257c] rounded-lg flex justify-center items-center gap-2 "
          >
            <img
              src="/images/icons/patientsWhiteIcon.svg"
              alt="patients icon"
            />
          ...
          <Link
            ...
            to="/dashboard/professional/tratamientos"
